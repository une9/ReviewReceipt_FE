...
interface ReviewReceiptProp {
  ...
  // myRef: React.RefAttributes<HTMLInputElement>,
...
const ReviewReceipt = forwardRef<HTMLInputElement, ReviewExtend>((props: ReviewExtend, ref: ForwardedRef<HTMLInputElement>) => {
  console.log(props)
  const {
    review_id,
    review_title,
